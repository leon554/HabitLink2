...
export default function DeleteArchiveGoal() {
    ...
    return (
        <div className="flex justify-center gap-3 w-full">
            <button className="rounded-xl w-full flex justify-center items-center px-5 outline-1 h-7 outline-border2 dark:text-subtext2 text-subtext1 hover:cursor-pointer hover:bg-panel2 transition-colors duration-150 ease-in-out "
                onClick={async () => {
