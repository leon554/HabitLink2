...
export default function GoalCompletionPanel() {
    return (
        <div className="shadow-sm shadow-gray-200 dark:shadow-none bg-panel1 w-[90%] max-w-[600px] rounded-2xl p-7 flex flex-col  gap-3 justify-center  text-title drop-shadow-md outline-1 outline-border">
